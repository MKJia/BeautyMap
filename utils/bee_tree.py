...
class BEETree: # Binary-Encoded Eliminate Tree (Any B Number in my mind?)
    ...
    def generate_sight_mask(self, k, minz_matrix, outlier_matrix):
        r = self.matrix_order
    ...
    def ray_casting(self, trigger, minz_matrix):
